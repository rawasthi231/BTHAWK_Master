                                ...
                                <Container fluid>
                                    <Row style={{padding:'20px 0px 2px 0px'}}>
                                        <Col md={4} className="form-group">
                                            <select defaultValue="" onChange={(event) => console.log(event.target.value)} className="form-control" name="selectCatagory" id="selectCatagory">
                                                <option value="" disabled>Select Category</option>
                                                {fetch.map((item, pos) => (
                                                    <option key={pos}>{item.category}</option>
                                                )
                                                )}
                                            </select>
                                        </Col>
                                        <Col md={4} className="form-group">
                                            <select defaultValue="" className="form-control" name="selectCatagory" id="selectCatagory">
                                    ...
                                    <Row style={{padding:'2px 0px 2px 0px'}}>
                                        ...
                                        <Col md={4} className="form-group">
                                            <select  defaultValue="" className="form-control" name="maintaineInventory" id="maintaineInventory">
                                                <option value="" disabled>Maintain Inventory</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select>
                                        </Col>
                                        ...
                                        <Col md={4} className="form-group">
                                            <select defaultValue="" className="form-control" name="item_type" id="item_type">
                                    ...
                                    <Row style={{padding:'2px 0px 2px 0px'}}>
                                        <Col md={4} className="form-group">
                                            <select  defaultValue="" className="form-control" name="cosumableRowProduct" id="cosumableRowProduct">
                                                <option value="" disabled>Consumable Raw Product</option>
                                                <option>FMCG</option>
                                                <option>Serial No</option>
                                            </select>
                                        </Col>
                                        ...
                                        <Col md={4} className="form-group">
                                            <select  defaultValue="" className="form-control" name="gstAppSale" id="gstAppSale">
                                                <option value="" disabled>GST Applicable on Sale</option>
                                                <option>Yes</option>
                                                <option>No</option>
                                            </select>
                                        </Col>
                                        ...
                                        <Col md={4} className="form-group">
                                            <select defaultValue="" className="form-control" name="productService" id="productService">
                                    ...
                                    <Row style={{padding:'2px 0px 2px 0px'}}>
                                        <Col md={4} className="form-group">
                                            <select defaultValue="" className="form-control" id="" name="">
                                                <option value="" disabled>Measurement Unit</option>
                                                <option>Gm</option>
                                                <option>Kg</option>
                                                <option>Meter</option>
                                                <option>Pcs</option>
