                ...
                <li>
                    <ul className="dropdown-menu-list scroller" style={{ height: "275px" }} data-handle-color="#637283">
                        <li>
                            <a href="#">
                                <span className="photo">
                                    <img src="./assets/layouts/layout/img/avatar2.jpg" className="img-circle" alt="" /> </span>
                        ...
                        <li>
                            <a href="#">
                                <span className="photo">
                                    <img src="./assets/layouts/layout/img/avatar3.jpg" className="img-circle" alt="" /> </span>
                                <span className="subject">
                        ...
                        <li>
                            <a href="#">
                                <span className="photo"><img src="./assets/layouts/layout/img/avatar1.jpg" className="img-circle" alt="" /></span>
                                <span className="subject">
